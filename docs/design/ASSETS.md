...
1. Pessoa real observando folha de soja, luz natural, enquadramento 16:9 e 3:2;
   obter autorização de imagem e registrar autor/data.
2. Três exemplos próprios de captura: folha nítida, distante e fora de foco;
   não associar uma hipótese fabricada a essas fotos.
3. Contexto de fileiras de soja e, se autorizado, equipe trabalhando no TCC.

Não guardar termos de autorização pessoais neste repositório. Quando recebidas,
registrar aqui autor, licença/autorização, crédito obrigatório, data, uso e texto
alternativo antes de publicar.
